...
basic.forever(function () {
    if (TobbieII.LBlock(310) && TobbieII.RBlock(310)) {
        arror_up1 = arror_up1 + 1
        TobbieII.backward()
        arrow_up2()
        music.playTone(392, music.beat(BeatFraction.Eighth))
        FB = 1
    } else if (!(TobbieII.LBlock(400)) && TobbieII.RBlock(400)) {
        arrow_right1 = arrow_right1 + 1
        TobbieII.leftward()
        arrow_right2()
        GOING = -1
    } else if (TobbieII.LBlock(400) && !(TobbieII.RBlock(400))) {
        arrow_left2 = arrow_left2 + 1
        TobbieII.rightward()
        arrow_left3()
        GOING = 1
